...
Welcome to the **GASTLI** documentation! GASTLI is a Python package developed for user-friendly modeling of 
exoplanet interiors with volatile-rich envelopes. 
...
- **Retrievals**: GASTLI is optimized to compute numerous models within a grid, allowing interpolation for retrievals on mass, radius, atmospheric metallicity, age, and/or internal temperature. See our :doc:`retrievals` section for a comprehensive guide on performing retrievals with GASTLI.
