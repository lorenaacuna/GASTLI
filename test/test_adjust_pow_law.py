...
# Output file
file_out = open('Output/Jupiter_MRrel_CMF10_logFeH_0.dat','w')
file_out.write('  M_pl[M_E]  M_tot[M_E]  x_core  ')
file_out.write('T_surf[K]  R_bulk[R_J]  R_total[R_J]  T_int[K]  Zenv  z_atm[R_J] ')
file_out.write("\n")



for k in range(16, n_mrel):
    ...
    my_coupling = cpl.coupling(path_to_file=path_input, pow_law_formass=0.32)
